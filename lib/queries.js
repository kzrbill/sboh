...
{
    this.get = function(topic, subscription, subscriptionFoundCallback, errorCallback)
    {   
        serviceBusService.getSubscription(topic, subscription, function(error, subscription, response){
            ...
            if(subscription)
            {
                subscriptionFoundCallback(subscription);
                return;
            }
        });
    }
...
module.exports.SubscriptionMapper = SubscriptionMapper;
module.exports.SubscriptionQuery = SubscriptionQuery;
